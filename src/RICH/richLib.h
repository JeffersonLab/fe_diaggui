...
/* 0x000C-0x0037 */ unsigned int		Reserved0[(0x0034-0x000C)/4];
/* 0x0034-0x0037 */ unsigned int		AdcTrigSrc;
/* 0x0038-0x003B */ unsigned int		AdcStartSrc;
...
/* 0x014C-0x01FF */ unsigned int		Reserved4[(0x0200-0x014C)/4];
} RICH_sd;
...
/* 0x3000-0x30FF */ RICH_Test			Testing;
} RICH_regs;
