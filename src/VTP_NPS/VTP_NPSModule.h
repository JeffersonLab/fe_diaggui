#ifndef VTP_NPSModule_H
#define VTP_NPSModule_H

#include "RootHeader.h"
#include "ModuleFrame.h"
#include "VTP_NPS_Scope.h"

class VTP_NPSModule : public ModuleFrame
{
public:
  VTP_NPSModule(const TGWindow *p, CrateMsgClient *pClient, unsigned int baseAddr) : ModuleFrame(p, pClient, baseAddr)
  {
    SetupRegisters();
    ...
    tFrame = pTabs->AddTab("Scope");      tFrame->AddFrame(new VTP_NPS_Scope(tFrame, this), new TGLayoutHints(kLHintsExpandX | kLHintsExpandY));
...
#define YEAR_MAP {\
	...
	{"SerdesCounters", 0},
      ...
      {"Cosmic", 0},
        {"Column_MultMin",  REGMEM_DESC_FLAGS_UINT, {0xB180, 0, 4, 32}},
        {"Column_DT",       REGMEM_DESC_FLAGS_UINT, {0xB180, 4, 3, 32}},
        {"Scint_DT",        REGMEM_DESC_FLAGS_UINT, {0xB180, 8, 3, 32}},
        {"Scint_TopEn",     REGMEM_DESC_FLAGS_UINT, {0xB180,16, 1, 32}},
        {"Scint_BotEn",     REGMEM_DESC_FLAGS_UINT, {0xB180,17, 1, 32}},
      {NULL, 0},
/*
      {"SolidECAL", 0},
        {"Clustering", 0},
...
*/
  ...
  const char *GetModuleName() { return "VTP_NPS"; }
  const char *GetModuleFullName() { return "VXS Trigger Processor-NPS"; }
