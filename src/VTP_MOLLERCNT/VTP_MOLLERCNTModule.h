#ifndef VTP_MOLLERCNTModule_H
#define VTP_MOLLERCNTModule_H

#include "RootHeader.h"
#include "ModuleFrame.h"

class VTP_MOLLERCNTModule : public ModuleFrame
{
public:
  VTP_MOLLERCNTModule(const TGWindow *p, CrateMsgClient *pClient, unsigned int baseAddr) : ModuleFrame(p, pClient, baseAddr)
  {
    SetupRegisters();
...
#define YEAR_MAP {\
    ...
    static RegMemDesc regs[] = {
      ...
      {"MollerCnt", 0},
	      {"FADCMult",            REGMEM_DESC_FLAGS_UINT,   {0xB800, 0, 9,32}},
	      {"WhichChIsTrig",       REGMEM_DESC_FLAGS_UINT,   {0xB800,16, 4,32}},
	      {"MultTriggerPulse",    REGMEM_DESC_FLAGS_UINT,   {0xB800,24, 8,32}},
      {NULL, 0},
  ...
  const char *GetModuleName() { return "VTP_MOLLERCNT"; }
  const char *GetModuleFullName() { return "VXS Trigger Processor-MOLLERCNT"; }
