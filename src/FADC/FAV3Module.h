 ...
 public:
	FAV3Module(const TGWindow * p, CrateMsgClient * pClient,
		...
		static RegMemDesc regs[] = {
			...
			{NULL, 0},
			{"ptw", REGMEM_DESC_FLAGS_UINT, {0x010E, 0, 9, 16}},
			{"pl", REGMEM_DESC_FLAGS_UINT, {0x0110, 0, 11, 16}},
			{"nsb", REGMEM_DESC_FLAGS_UINT, {0x0112, 0, 9, 16}},
			{"nsa", REGMEM_DESC_FLAGS_UINT, {0x0114, 0, 9, 16}},
			{NULL, 0},
			{"Scalers", 0},
			...
			{"adc_status0", REGMEM_DESC_FLAGS_HEX, {0x0100, 0, 16, 16}},
			{"adc_status1", REGMEM_DESC_FLAGS_HEX, {0x0102, 0, 16, 16}},
			{"adc_status2", REGMEM_DESC_FLAGS_HEX, {0x0104, 0, 16, 16}},
			{"adc_config1", REGMEM_DESC_FLAGS_HEX, {0x0106, 0, 16, 16}},
			{"adc_config2", REGMEM_DESC_FLAGS_HEX, {0x0108, 0, 16, 16}},
			{"adc_config4", REGMEM_DESC_FLAGS_HEX, {0x010A, 0, 16, 16}},
			{"adc_config5", REGMEM_DESC_FLAGS_HEX, {0x010C, 0, 16, 16}},
			{"adc_config6", REGMEM_DESC_FLAGS_UINT, {0x0136, 0, 16, 16}},
			{"adc_config7", REGMEM_DESC_FLAGS_UINT, {0x0138, 0, 16, 16}},
			{"adc_test_data", REGMEM_DESC_FLAGS_HEX, {0x013A, 0, 16, 16}},
