	...
	void SetupRegisters()
	{
		static RegMemDesc regs[] = {
          ...
          {NULL, 0},
					...
					{NULL, 0},
					{"PlaybackIgnore", 0},
						{"pb_ignore0",	REGMEM_DESC_FLAGS_UINT,		{0x012C, 29, 1, 32}},
						{"pb_ignore1",	REGMEM_DESC_FLAGS_UINT,		{0x012C, 13, 1, 32}},
						{"pb_ignore2",	REGMEM_DESC_FLAGS_UINT,		{0x0130, 29, 1, 32}},
						{"pb_ignore3",	REGMEM_DESC_FLAGS_UINT,		{0x0130, 13, 1, 32}},
						{"pb_ignore4",	REGMEM_DESC_FLAGS_UINT,		{0x0134, 29, 1, 32}},
						{"pb_ignore5",	REGMEM_DESC_FLAGS_UINT,		{0x0134, 13, 1, 32}},
						{"pb_ignore6",	REGMEM_DESC_FLAGS_UINT,		{0x0138, 29, 1, 32}},
						{"pb_ignore7",	REGMEM_DESC_FLAGS_UINT,		{0x0138, 13, 1, 32}},
						{"pb_ignore8",	REGMEM_DESC_FLAGS_UINT,		{0x013C, 29, 1, 32}},
						{"pb_ignore9",	REGMEM_DESC_FLAGS_UINT,		{0x013C, 13, 1, 32}},
						{"pb_ignore10",	REGMEM_DESC_FLAGS_UINT,		{0x0140, 29, 1, 32}},
						{"pb_ignore11",	REGMEM_DESC_FLAGS_UINT,		{0x0140, 13, 1, 32}},
						{"pb_ignore12",	REGMEM_DESC_FLAGS_UINT,		{0x0144, 29, 1, 32}},
						{"pb_ignore13",	REGMEM_DESC_FLAGS_UINT,		{0x0144, 13, 1, 32}},
						{"pb_ignore14",	REGMEM_DESC_FLAGS_UINT,		{0x0148, 29, 1, 32}},
						{"pb_ignore15",	REGMEM_DESC_FLAGS_UINT,		{0x0148, 13, 1, 32}},
					{NULL, 0},
					...
					{NULL, 0},
					{"AdcInvert", 0},
						{"ch0",	REGMEM_DESC_FLAGS_UINT,		{0x012C, 30, 1, 32}},
						{"ch1",	REGMEM_DESC_FLAGS_UINT,		{0x012C, 14, 1, 32}},
						{"ch2",	REGMEM_DESC_FLAGS_UINT,		{0x0130, 30, 1, 32}},
						{"ch3",	REGMEM_DESC_FLAGS_UINT,		{0x0130, 14, 1, 32}},
						{"ch4",	REGMEM_DESC_FLAGS_UINT,		{0x0134, 30, 1, 32}},
						{"ch5",	REGMEM_DESC_FLAGS_UINT,		{0x0134, 14, 1, 32}},
						{"ch6",	REGMEM_DESC_FLAGS_UINT,		{0x0138, 30, 1, 32}},
						{"ch7",	REGMEM_DESC_FLAGS_UINT,		{0x0138, 14, 1, 32}},
						{"ch8",	REGMEM_DESC_FLAGS_UINT,		{0x013C, 30, 1, 32}},
						{"ch9",	REGMEM_DESC_FLAGS_UINT,		{0x013C, 14, 1, 32}},
						{"ch10",	REGMEM_DESC_FLAGS_UINT,		{0x0140, 30, 1, 32}},
						{"ch11",	REGMEM_DESC_FLAGS_UINT,		{0x0140, 14, 1, 32}},
						{"ch12",	REGMEM_DESC_FLAGS_UINT,		{0x0144, 30, 1, 32}},
						{"ch13",	REGMEM_DESC_FLAGS_UINT,		{0x0144, 14, 1, 32}},
						{"ch14",	REGMEM_DESC_FLAGS_UINT,		{0x0148, 30, 1, 32}},
						{"ch15",	REGMEM_DESC_FLAGS_UINT,		{0x0148, 14, 1, 32}},
					{NULL, 0},
					{"AdcPedestal", 0},
