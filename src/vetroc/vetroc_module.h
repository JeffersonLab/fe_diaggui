...
>>>>>>> f034e2a9f00ba6f826f8c5e109912daef9e3d596
...
#define VETROC_SDIOMUX_NAME_MAP {\
    ...
    static RegMemDesc regs[] = {
      ...
      {"TDC0-15", 0},
        ...
        {"Invert",      REGMEM_DESC_FLAGS_HEX,    {0x1008, 0, 16, 32}},
        {"Delay",       REGMEM_DESC_FLAGS_UINT,   {0x100C, 0,  8, 32}},
      {NULL, 0},
      {"TDC16-31", 0},
        {"EnableN",     REGMEM_DESC_FLAGS_HEX,    {0x1100, 0, 16, 32}},
        {"TrigWidth",   REGMEM_DESC_FLAGS_UINT,   {0x1104, 0, 12, 32}},
        {"Invert",      REGMEM_DESC_FLAGS_HEX,    {0x1108, 0, 16, 32}},
        {"Delay",       REGMEM_DESC_FLAGS_UINT,   {0x110C, 0,  8, 32}},
      {NULL, 0},
      {"TDC32-47", 0},
        {"EnableN",     REGMEM_DESC_FLAGS_HEX,    {0x1200, 0, 16, 32}},
        {"TrigWidth",   REGMEM_DESC_FLAGS_UINT,   {0x1204, 0, 12, 32}},
        {"Invert",      REGMEM_DESC_FLAGS_HEX,    {0x1208, 0, 16, 32}},
        {"Delay",       REGMEM_DESC_FLAGS_UINT,   {0x120C, 0,  8, 32}},
      {NULL, 0},
      {"TDC48-63", 0},
        {"EnableN",     REGMEM_DESC_FLAGS_HEX,    {0x1300, 0, 16, 32}},
        {"TrigWidth",   REGMEM_DESC_FLAGS_UINT,   {0x1304, 0, 12, 32}},
        {"Invert",      REGMEM_DESC_FLAGS_HEX,    {0x1308, 0, 16, 32}},
        {"Delay",       REGMEM_DESC_FLAGS_UINT,   {0x130C, 0,  8, 32}},
      {NULL, 0},
      {"TDC64-79", 0},
        {"EnableN",     REGMEM_DESC_FLAGS_HEX,    {0x1400, 0, 16, 32}},
        {"TrigWidth",   REGMEM_DESC_FLAGS_UINT,   {0x1404, 0, 12, 32}},
        {"Invert",      REGMEM_DESC_FLAGS_HEX,    {0x1408, 0, 16, 32}},
        {"Delay",       REGMEM_DESC_FLAGS_UINT,   {0x140C, 0,  8, 32}},
      {NULL, 0},
      {"TDC80-95", 0},
        {"EnableN",     REGMEM_DESC_FLAGS_HEX,    {0x1500, 0, 16, 32}},
        {"TrigWidth",   REGMEM_DESC_FLAGS_UINT,   {0x1504, 0, 12, 32}},
        {"Invert",      REGMEM_DESC_FLAGS_HEX,    {0x1508, 0, 16, 32}},
        {"Delay",       REGMEM_DESC_FLAGS_UINT,   {0x150C, 0,  8, 32}},
      {NULL, 0},
      {"TDC96-111", 0},
        {"EnableN",     REGMEM_DESC_FLAGS_HEX,    {0x1600, 0, 16, 32}},
        {"TrigWidth",   REGMEM_DESC_FLAGS_UINT,   {0x1604, 0, 12, 32}},
        {"Invert",      REGMEM_DESC_FLAGS_HEX,    {0x1608, 0, 16, 32}},
        {"Delay",       REGMEM_DESC_FLAGS_UINT,   {0x160C, 0,  8, 32}},
      {NULL, 0},
      {"TDC112-127", 0},
        {"EnableN",     REGMEM_DESC_FLAGS_HEX,    {0x1700, 0, 16, 32}},
        {"TrigWidth",   REGMEM_DESC_FLAGS_UINT,   {0x1704, 0, 12, 32}},
        {"Invert",      REGMEM_DESC_FLAGS_HEX,    {0x1708, 0, 16, 32}},
        {"Delay",       REGMEM_DESC_FLAGS_UINT,   {0x170C, 0,  8, 32}},
      {NULL, 0},
      {"Serdes", 0},
