		...
		static RegMemDesc regs[] = {
			...
			{"Sd", 0},
				{"Scalers", 0},
					...
					{"Clear",					REGMEM_DESC_FLAGS_UINT,		{0x0200, 1, 1, 32}},
			...
			{"VETROCTrigger", 0},
				{"EnabledVETROCs", 0},
					...
					{"PP16(Slot20)",			REGMEM_DESC_FLAGS_UINT,		{0x2000, 15, 1, 32}},
				{NULL, 0},
				{"Latency Status",			REGMEM_DESC_FLAGS_UINT,		{0x2004, 0, 1, 32}},
				{"Latency",						REGMEM_DESC_FLAGS_UINT,		{0x2008, 0, 12, 32}},
				{"ClusterThreshold",			REGMEM_DESC_FLAGS_UINT,		{0x200C, 0, 3, 32}},
			{NULL, 0}
		};
