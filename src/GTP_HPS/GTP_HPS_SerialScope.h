#ifndef GTP_HPS_SERIALSCOPE_H
#define GTP_HPS_SERIALSCOPE_H

#include "RootHeader.h"
#include "ModuleFrame.h"
#include "Scope.h"

class GTP_HPS_SerialScope	: public TGCompositeFrame
{
public:
	GTP_HPS_SerialScope(const TGWindow *p, ModuleFrame *pModule, int idx) : TGCompositeFrame(p)
	{
