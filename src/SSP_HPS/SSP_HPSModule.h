...
#define SSP_SDIOMUX_NAME_MAP		{\
		...
		static RegMemDesc regs[] = {
			...
			{"Hps", 0},
				{"Singles Trigger", 0},
					{"SinglesTopEn",		REGMEM_DESC_FLAGS_UINT,		{0x0500, 0, 1, 32}},
					{"SinglesBotEn",		REGMEM_DESC_FLAGS_UINT,		{0x0500, 1, 1, 32}},
					{"Latency",				REGMEM_DESC_FLAGS_UINT,		{0x0504, 0, 10, 32}},
					{"Emin",					REGMEM_DESC_FLAGS_UINT,		{0x0518, 0, 13, 32}},
					{"Emax",					REGMEM_DESC_FLAGS_UINT,		{0x051C, 0, 13, 32}},
					{"Nmin",					REGMEM_DESC_FLAGS_UINT,		{0x0520, 0, 4, 32}},
					{"ScalerSinglePass",	REGMEM_DESC_FLAGS_UINT,		{0x0580, 0, 32, 32}},
					{"ScalerSignleTot",	REGMEM_DESC_FLAGS_UINT,		{0x0584, 0, 32, 32}},
				{NULL, 0},
			{NULL, 0},
